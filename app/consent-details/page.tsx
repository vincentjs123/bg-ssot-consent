...
function SectionCardComponent({ card, visibleSections, visibleChannels, showEdit }: CardProps) {
  ...
  return (
    <div className="flex flex-col border border-border-subtle rounded-[4px]" style={{ alignSelf: "start", position: "relative", zIndex: menuOpen ? 10 : 0 }}>
      <div style={{ background: card.isCKR ? `var(--button-secondary-btn-secondary-bg-active)` : "var(--deepblue-color-primary-500)", padding: "8px 12px", minHeight: 88, display: "flex", alignItems: "center", borderRadius: "4px 4px 0 0" }}>
        <p style={{
          fontFamily: "var(--font-barlow), sans-serif",
          fontWeight: 300,
          fontSize: 28,
